					...
					<div class="col-md-8">
						<div class="jumbotron well">
							...
							<table id="table-uta" class="display nowrap" cellspacing="0" width="100%">
								...
								<tbody>
									<?php
										$sql2="SELECT * FROM programas WHERE id_laptop = '".$_GET['id']."'";
										$result = mysqli_query($mysqli, $sql2);
										while ($var= mysqli_fetch_array($result)){ ?>
											<tr>
												<td style='text-align:center;'><?php echo $var['programa'];?></td>
												<td style='text-align:center;'><a style='text-align:center;' href='#' onclick='deletePrograma("<?php echo $var['programa'];?>","<?php echo $var['id_programa'];?>")' role='button' class='btn'><img src='img/cancel.png' width='25px'/></a>
												</td>
											</tr>
									<?php } 
									?>
